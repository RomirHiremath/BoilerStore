    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <TrendingUp className="w-5 h-5 text-[--purdue-gold]" />
          Demand Forecast
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
          ...
          {categories.map((cat) => (
            <Button
              ...
              className={selectedCategory === cat ? 
                "bg-[--purdue-gold] hover:bg-amber-500 text-black border border-black" : 
        ...
        {isLoading ? (
          <div className="text-center py-8">
            <div className="animate-spin w-8 h-8 border-2 border-[--purdue-gold] border-t-transparent rounded-full mx-auto mb-2" />
