  ...
  return (
    <>
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-white">
        ...
        <p className="text-gray-600 mb-8">Fill out the details below to sell your item on the exchange.</p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><Camera className="w-5 h-5 text-[--purdue-gold]"/>Photos</CardTitle>
                </CardHeader>
                <CardContent>
                     <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
                        ...
                        {formData.images.length < 8 && (
                            <label className="aspect-square border-2 border-dashed rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-[--purdue-gold] hover:bg-amber-50 transition-colors">
                                <input type="file" multiple accept="image/*" className="hidden" onChange={(e) => handleImageUpload(e.target.files)} disabled={isUploading} />
                                {isUploading ? <Loader2 className="w-8 h-8 text-[--purdue-gold] animate-spin" /> : <Upload className="w-8 h-8 text-gray-400" />}
                            </label>
                        )}
                    </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Phone className="w-5 h-5 text-[--purdue-gold]"/>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <UserIcon className="w-5 h-5 text-[--purdue-gold]" />
              Welcome to Boiler Exchange!
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-3">
              ...
              <Button onClick={handleGuestNameSubmit} className="bg-[--purdue-gold] hover:bg-amber-500 text-black border border-black">
                Continue
              </Button>
            </div>
          </div>
      ...
      <Dialog open={showPhoneModal} onOpenChange={() => {}}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button onClick={handlePhoneSubmit} className="bg-[--purdue-gold] hover:bg-amber-500 text-black border border-black">
                Continue
              </Button>
            </div>
          </div>
